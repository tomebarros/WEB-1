...
<body>
  ...
  <div class="header">
    <div class="row mx-3">
      ...
      <div class="col-xl-3 shadow p-4 mb-3 bg-white mx-auto rounded-lg kotak">
        ...
        if (isset($_GET['pesan'])) {
          if ($_GET['pesan'] == "gagal") {
            echo "<div class='alert alert-danger shake-horizontal'><i class='bi bi-exclamation-triangle-fill'></i> Login Gagal Email Dan Password Salah</div>";
          } else if ($_GET['pesan'] == "belum_login") {
            echo "<div class='alert alert-info shake-horizontal'>Anda Harus Login Untuk Mengakses Halaman Super Admin</div>";
